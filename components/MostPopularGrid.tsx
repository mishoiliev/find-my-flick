...
export default function MostPopularGrid({ shows }: MostPopularGridProps) {
  if (shows.length === 0) {
    return (
  ...
  // Limit to 8 items (2 rows x 4 cols on desktop, 4 rows x 2 cols on mobile)
  const displayShows = shows.slice(0, 8);
